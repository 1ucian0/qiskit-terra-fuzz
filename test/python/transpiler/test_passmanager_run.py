...
from qiskit.transpiler.preset_passmanagers import default_pass_manager
from qiskit.transpiler import transpile, TranspilerError
...
class TestPassManagerRun(QiskitTestCase):
    ...
    def test_default_pass_manager_single(self):
        ...
        pass_manager = default_pass_manager(basis_gates=basis_gates,
